...
public class MainActivity extends AppCompatActivity {
                ...
                public void onClick(View view) {
                    ...
                    alertDialogBuilder.setPositiveButton("UPLOAD", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Question ques=new Question("student",input.getText().toString(),"Aman",cdt,"question",3,"",null);
    ...
    public void UploadAnswer(View view)
    {
        ...
        if(answer!=null && answer!="" && answer.length()!=0)
        {
            ...
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");
            String cdt = sdf.format(new Date());
            Answer ans=new Answer("student",answer,"Aman",cdt,"answer",3);
            answerList.add(ans);
            ...
            et.setText("");
            et.clearFocus();
            //Toast.makeText(this, "KEY:"+key+"\n Ans:"+answer, Toast.LENGTH_SHORT).show();
        }
        else
        {
